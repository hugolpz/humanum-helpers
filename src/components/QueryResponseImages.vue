  ...
  <div class="img-gallery">
    ...
    <template v-else>
      <div class="img-topbar">
        <span class="badge badge-blue">{{ imageRows.length }} images</span>
...
import { resolveCommonsUrl, isCommonsFilePath } from '@/utils/CommonsURL.js'
...
// Detect all columns that may contain Common image URLs
